...
class ResponsaveisAdmin(admin.ModelAdmin):
    list_display =('nome_responsavel', 'sobrenome_responsavel', 'numero_telefone_responsavel', 'email', 'CPF', 'data_nascimento_responsavel' )
...
class AlunoAdmin(admin.ModelAdmin):
    list_display =('nome_aluno', 'sobrenome_aluno', 'numero_telefone_aluno', 'email_aluno', 'CPF_aluno', 'data_nascimento_aluno' 'class_choices' )
...
class ProfessorAdmin(admin.ModelAdmin):
    list_display =('nome_professor', 'sobrenome_professor', 'numero_telefone_professor', 'email_progessor', 'CPF_professor', 'data_nascimento_professor' 'class_choices' )
